...
# ===== 出力（課別配布：サンプル回答 Step9）=====
OUT_DIR = r"C:\Users\SujiT\OneDrive\ドキュメント\HiproBiz わかもと製薬\2026.02.27 わかもと製薬　KPI振り返り研修Part2\41_課別配布サンプルシート_Step9"

# ===== 対象シート名（半角9）=====
TARGET_SHEET_NAME = "WS_サンプル回答_Step9"
...
def main() -> None:
    ...
    try:
        ...
        for idx, dept in enumerate(DEPT_ORDER, start=1):
            ...
            out_name = f"{idx:02d}_{safe_filename(dept)}_サンプル回答_Step9.xlsx"
        ...
        print("完了：WS_サンプル回答_Step9 を課別に分割しました。")
