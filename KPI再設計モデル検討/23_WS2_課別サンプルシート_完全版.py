...
# ===== 出力（課別配布：サンプル回答 完全版）=====
OUT_DIR = r"C:\Users\SujiT\OneDrive\ドキュメント\HiproBiz わかもと製薬\2026.02.27 わかもと製薬　KPI振り返り研修Part2\44_課別配布サンプルシート_完全版"

# ===== 対象シート名 =====
TARGET_SHEET_NAME = "WS_サンプル回答"
...
def main() -> None:
    ...
    try:
        ...
        for idx, dept in enumerate(DEPT_ORDER, start=1):
            ...
            out_name = f"{idx:02d}_{safe_filename(dept)}_サンプル回答_完全版.xlsx"
        ...
        print("完了：WS_サンプル回答 を課別に分割し、指定フォルダーへ保存しました。")
