...
# ===== 出力（課別配布サンプル）=====
OUT_DIR = r"C:\Users\SujiT\OneDrive\ドキュメント\HiproBiz わかもと製薬\KPI振り返りシート\20研修_KPI振り返りシート_最終案\WSテンプレート\課別配布サンプルシート_分類決定フェーズ"

# ===== 対象シート名 =====
TARGET_SHEET_NAME = "分類決定フェーズ"
...
def main() -> None:
    ...
    try:
        ...
        for idx, dept in enumerate(DEPT_ORDER, start=1):
            ...
            out_name = f"{idx:02d}_{safe_filename(dept)}_分類決定フェーズ.xlsx"
